...
namespace Points
{
    ...
    {
        public int NumberPattern { get; private set; }
...
//            if (pat448_2.Count() > 0) return new Dot(pat448_2.First().x + 1, pat448_2.First().y - 1);
            ...
            var pat279 = from Dot d in get_non_blocked
                         where d.Own == Owner && d.x>1 && d.x < iBoardWidth - 1
                             && aDots[d.x - 1, d.y - 1].Own == enemy_own && aDots[d.x - 1, d.y - 1].Blocked == false
                             && aDots[d.x, d.y - 1].Own == enemy_own && aDots[d.x, d.y - 1].Blocked == false
                             && aDots[d.x + 1, d.y].Own == enemy_own && aDots[d.x + 1, d.y].Blocked == false
                             && aDots[d.x + 1, d.y + 1].Own == enemy_own && aDots[d.x + 1, d.y + 1].Blocked == false
...
&& aDots[d.x, d.y + 1].Own == 0 && aDots[d.x, d.y + 1].Blocked == false
            ...
            var pat879_2_3 = from Dot d in get_non_blocked
                             where d.Own == Owner && d.x + 4 < iBoardWidth && d.x - 4 > 0 && d.y + 4 < iBoardHeight && d.y - 4 > 0
&& aDots[d.x + 3, d.y + 3].Own == Owner && aDots[d.x + 3, d.y + 3].Blocked == false
...
&& aDots[d.x - 1, d.y].Own != enemy_own
            ...
            var pat517 = from Dot d in get_non_blocked
                         where d.Own == Owner && (d.x - 1) > 0 && (d.y + 2) < iBoardHeight && (d.x + 2) < iBoardHeight && (d.y - 1) > 0
&& aDots[d.x, d.y - 1].Own == Owner && aDots[d.x , d.y - 1].Blocked == false
&& aDots[d.x + 1, d.y - 1].Own == enemy_own && aDots[d.x + 1, d.y - 1].Blocked == false 
&& aDots[d.x + 1, d.y].Own == 0 && aDots[d.x + 1, d.y ].Blocked == false
&& aDots[d.x + 1, d.y + 1].Own == 0 && aDots[d.x + 1, d.y + 1].Blocked == false
...
&& aDots[d.x + 2, d.y].Own == enemy_own && aDots[d.x + 2, d.y].Blocked == false
            ...
            var pat726 = from Dot d in get_non_blocked
                         where d.Own == Owner && d.x > 1 && d.y > 1 && d.x < iBoardWidth - 1 && d.y < iBoardHeight - 1
                             && aDots[d.x - 1, d.y].Own == Owner && aDots[d.x - 1, d.y].Blocked == false
                             && aDots[d.x - 2, d.y - 1].Own == enemy_own && aDots[d.x - 2, d.y - 1].Blocked == false
                             && aDots[d.x - 1, d.y - 1].Own == 0 && aDots[d.x - 1, d.y - 1].Blocked == false
                             && aDots[d.x + 1, d.y - 1].Own == 0 && aDots[d.x + 1, d.y - 1].Blocked == false
            ...
            var pat15 = from Dot d in get_non_blocked
                        where d.Own == Owner && d.x + 2 == iBoardWidth
                            && aDots[d.x + 1, d.y + 1].Own == enemy_own && aDots[d.x + 1, d.y + 1].Blocked == false
                            && aDots[d.x, d.y + 1].Own == enemy_own && aDots[d.x, d.y + 1].Blocked == false
                            && aDots[d.x + 1, d.y].Own == 0 && aDots[d.x + 1, d.y].Blocked == false
                        select d;
            ...
            var pat15_2_3_4 = from Dot d in get_non_blocked
                              where d.Own == Owner && d.y + 2 == iBoardHeight
                                  && aDots[d.x + 1, d.y + 1].Own == enemy_own && aDots[d.x + 1, d.y + 1].Blocked == false
                                  && aDots[d.x + 1, d.y].Own == enemy_own && aDots[d.x + 1, d.y].Blocked == false
                                  && aDots[d.x, d.y + 1].Own == 0 && aDots[d.x, d.y + 1].Blocked == false
                              select d;
...
//============================================================================================================== 
 ...
 var pat80 = from Dot d in aDots
              where d.Own == Owner
                  ...
                  && aDots[d.x + 2, d.y - 3].Own == 0 && aDots[d.x + 2, d.y - 3].Blocked == false
              select d;
 if (pat80.Count() > 0) return new Dot(pat80.First().x + 1, pat80.First().y - 2);
 //180 Rotate=========================================================================================================== 
 var pat80_2 = from Dot d in aDots
                where d.Own == enemy_own
                    && aDots[d.x - 3, d.y + 3].Own == enemy_own && aDots[d.x - 3, d.y + 3].Blocked == false
                    && aDots[d.x - 1, d.y + 1].Own == 0 && aDots[d.x - 1, d.y + 1].Blocked == false
                    && aDots[d.x - 2, d.y + 2].Own == 0 && aDots[d.x - 2, d.y + 2].Blocked == false
                    && aDots[d.x, d.y + 1].Own == 0 && aDots[d.x, d.y + 1].Blocked == false
                    && aDots[d.x, d.y + 2].Own == 0 && aDots[d.x, d.y + 2].Blocked == false
                    ...
                    && aDots[d.x - 2, d.y + 3].Own == 0 && aDots[d.x - 2, d.y + 3].Blocked == false
                select d;
 if (pat80_2.Count() > 0) return new Dot(pat80_2.First().x - 1, pat80_2.First().y + 2);
 //--------------Rotate on 90----------------------------------- 
 var pat80_2_3 = from Dot d in aDots
                  where d.Own == enemy_own
                      ...
                      && aDots[d.x + 3, d.y - 2].Own == 0 && aDots[d.x + 3, d.y - 2].Blocked == false
                  select d;
 if (pat80_2_3.Count() > 0) return new Dot(pat80_2_3.First().x + 2, pat80_2_3.First().y - 1);
 //--------------Rotate on 90 - 2----------------------------------- 
 var pat80_2_3_4 = from Dot d in aDots
                    where d.Own == enemy_own
                        ...
                        && aDots[d.x - 3, d.y + 2].Own == 0 && aDots[d.x - 3, d.y + 2].Blocked == false
                    select d;
 if (pat80_2_3_4.Count() > 0) return new Dot(pat80_2_3_4.First().x - 2, pat80_2_3_4.First().y + 1);
 //============================================================================================================== 
 //============================================================================================================== 
 NumberPattern = 1224;
 ...
 //============================================================================================================== 
 NumberPattern = 330;
 var pat330 = from Dot d in aDots
              where d.Own == Owner
                  && aDots[d.x + 2, d.y - 5].Own == Owner && aDots[d.x + 2, d.y - 5].Blocked == false
                  && aDots[d.x + 1, d.y - 5].Own == 0 && aDots[d.x + 1, d.y - 5].Blocked == false
                  && aDots[d.x + 1, d.y - 4].Own == 0 && aDots[d.x + 1, d.y - 4].Blocked == false
                  && aDots[d.x, d.y - 4].Own == 0 && aDots[d.x, d.y - 4].Blocked == false
                  && aDots[d.x, d.y - 3].Own == 0 && aDots[d.x, d.y - 3].Blocked == false
                  ...
                  && aDots[d.x - 1, d.y - 4].Own == 0 && aDots[d.x - 1, d.y - 4].Blocked == false
                  && aDots[d.x + 1, d.y - 6].Own == 0 && aDots[d.x + 1, d.y - 6].Blocked == false
                  && aDots[d.x - 1, d.y].Own == 0 && aDots[d.x - 1, d.y].Blocked == false
              select d;
 if (pat330.Count() > 0) return new Dot(pat330.First().x, pat330.First().y - 4);
 //180 Rotate=========================================================================================================== 
 var pat330_2 = from Dot d in aDots
                where d.Own == Owner
                    && aDots[d.x - 2, d.y + 5].Own == Owner && aDots[d.x - 2, d.y + 5].Blocked == false
                    && aDots[d.x - 1, d.y + 5].Own == 0 && aDots[d.x - 1, d.y + 5].Blocked == false
                    && aDots[d.x - 1, d.y + 4].Own == 0 && aDots[d.x - 1, d.y + 4].Blocked == false
                    ...
                    && aDots[d.x + 1, d.y].Own == 0 && aDots[d.x + 1, d.y].Blocked == false
                select d;
 if (pat330_2.Count() > 0) return new Dot(pat330_2.First().x, pat330_2.First().y + 4);
 //--------------Rotate on 90----------------------------------- 
 var pat330_2_3 = from Dot d in aDots
                  where d.Own == Owner
                      && aDots[d.x + 5, d.y - 2].Own == Owner && aDots[d.x + 5, d.y - 2].Blocked == false
                      && aDots[d.x + 5, d.y - 1].Own == 0 && aDots[d.x + 5, d.y - 1].Blocked == false
                      && aDots[d.x + 4, d.y - 1].Own == 0 && aDots[d.x + 4, d.y - 1].Blocked == false
                      && aDots[d.x + 4, d.y].Own == 0 && aDots[d.x + 4, d.y].Blocked == false
                      && aDots[d.x + 3, d.y].Own == 0 && aDots[d.x + 3, d.y].Blocked == false
                      ...
                      && aDots[d.x + 4, d.y + 1].Own == 0 && aDots[d.x + 4, d.y + 1].Blocked == false
                      && aDots[d.x + 6, d.y - 1].Own == 0 && aDots[d.x + 6, d.y - 1].Blocked == false
                      && aDots[d.x, d.y + 1].Own == 0 && aDots[d.x, d.y + 1].Blocked == false
                  select d;
 if (pat330_2_3.Count() > 0) return new Dot(pat330_2_3.First().x + 4, pat330_2_3.First().y);
 //--------------Rotate on 90 - 2----------------------------------- 
 var pat330_2_3_4 = from Dot d in aDots
                    where d.Own == Owner
                        && aDots[d.x - 5, d.y + 2].Own == Owner && aDots[d.x - 5, d.y + 2].Blocked == false
                        && aDots[d.x - 5, d.y + 1].Own == 0 && aDots[d.x - 5, d.y + 1].Blocked == false
                        && aDots[d.x - 4, d.y + 1].Own == 0 && aDots[d.x - 4, d.y + 1].Blocked == false
                        ...
                        && aDots[d.x, d.y - 1].Own == 0 && aDots[d.x, d.y - 1].Blocked == false
                    select d;
 if (pat330_2_3_4.Count() > 0) return new Dot(pat330_2_3_4.First().x - 4, pat330_2_3_4.First().y);
 //============================================================================================================== 
 NumberPattern = 331;
 var pat331 = from Dot d in aDots
              where d.Own == Owner
                  && aDots[d.x - 2, d.y - 1].Own == enemy_own && aDots[d.x - 2, d.y - 1].Blocked == false
                  && aDots[d.x + 2, d.y + 1].Own == enemy_own && aDots[d.x + 2, d.y + 1].Blocked == false
                  && aDots[d.x - 2, d.y - 1].IndexRelation == aDots[d.x + 2, d.y + 1].IndexRelation
                  && aDots[d.x - 1, d.y - 1].Own == 0 && aDots[d.x - 1, d.y - 1].Blocked == false
                  && aDots[d.x, d.y - 1].Own == 0 && aDots[d.x, d.y - 1].Blocked == false
                  && aDots[d.x + 1, d.y - 1].Own == 0 && aDots[d.x + 1, d.y - 1].Blocked == false
                  && aDots[d.x + 2, d.y - 1].Own == 0 && aDots[d.x + 2, d.y - 1].Blocked == false
                  ...
                  && aDots[d.x + 1, d.y].Own == 0 && aDots[d.x + 1, d.y].Blocked == false
              select d;
 if (pat331.Count() > 0) return new Dot(pat331.First().x + 1, pat331.First().y - 1);
 //180 Rotate=========================================================================================================== 
 var pat331_2 = from Dot d in aDots
                where d.Own == Owner
                    && aDots[d.x + 2, d.y + 1].Own == enemy_own && aDots[d.x + 2, d.y + 1].Blocked == false
                    && aDots[d.x - 2, d.y - 1].Own == enemy_own && aDots[d.x - 2, d.y - 1].Blocked == false
                    && aDots[d.x + 2, d.y + 1].IndexRelation == aDots[d.x - 2, d.y - 1].IndexRelation
                    ...
                    && aDots[d.x - 1, d.y].Own == 0 && aDots[d.x - 1, d.y].Blocked == false
                select d;
 if (pat331_2.Count() > 0) return new Dot(pat331_2.First().x - 1, pat331_2.First().y + 1);
 //--------------Rotate on 90----------------------------------- 
 var pat331_2_3 = from Dot d in aDots
                  where d.Own == Owner
                      && aDots[d.x + 1, d.y + 2].Own == enemy_own && aDots[d.x + 1, d.y + 2].Blocked == false
                      && aDots[d.x - 1, d.y - 2].Own == enemy_own && aDots[d.x - 1, d.y - 2].Blocked == false
                      && aDots[d.x + 1, d.y + 2].IndexRelation == aDots[d.x - 1, d.y - 2].IndexRelation
                      && aDots[d.x + 1, d.y + 1].Own == 0 && aDots[d.x + 1, d.y + 1].Blocked == false
                      && aDots[d.x + 1, d.y].Own == 0 && aDots[d.x + 1, d.y].Blocked == false
                      && aDots[d.x + 1, d.y - 1].Own == 0 && aDots[d.x + 1, d.y - 1].Blocked == false
                      && aDots[d.x + 1, d.y - 2].Own == 0 && aDots[d.x + 1, d.y - 2].Blocked == false
                      ...
                      && aDots[d.x, d.y - 1].Own == 0 && aDots[d.x, d.y - 1].Blocked == false
                  select d;
 if (pat331_2_3.Count() > 0) return new Dot(pat331_2_3.First().x + 1, pat331_2_3.First().y - 1);
 //--------------Rotate on 90 - 2----------------------------------- 
 var pat331_2_3_4 = from Dot d in aDots
                    where d.Own == Owner
                        && aDots[d.x - 1, d.y - 2].Own == enemy_own && aDots[d.x - 1, d.y - 2].Blocked == false
                        && aDots[d.x + 1, d.y + 2].Own == enemy_own && aDots[d.x + 1, d.y + 2].Blocked == false
                        && aDots[d.x - 1, d.y - 2].IndexRelation == aDots[d.x + 1, d.y + 2].IndexRelation
                        ...
                        && aDots[d.x, d.y + 1].Own == 0 && aDots[d.x, d.y + 1].Blocked == false
                    select d;
 if (pat331_2_3_4.Count() > 0) return new Dot(pat331_2_3_4.First().x - 1, pat331_2_3_4.First().y + 1);
 //============================================================================================================== 
 NumberPattern = 312;
 var pat312 = from Dot d in aDots
              where d.Own == Owner
                  & aDots[d.x - 1, d.y - 1].Own == enemy_own & aDots[d.x - 1, d.y - 1].Blocked == false
                  & aDots[d.x + 1, d.y + 2].Own == enemy_own & aDots[d.x + 1, d.y + 2].Blocked == false
                  & aDots[d.x, d.y + 1].Own != enemy_own & aDots[d.x, d.y + 1].Blocked == false
                  ...
                  & aDots[d.x + 2, d.y + 1].Own == 0 & aDots[d.x + 2, d.y + 1].Blocked == false
              select d;
 if (pat312.Count() > 0) return new Dot(pat312.First().x + 1, pat312.First().y - 1);
 //180 Rotate=========================================================================================================== 
 var pat312_2 = from Dot d in aDots
                where d.Own == Owner
                    & aDots[d.x + 1, d.y + 1].Own == enemy_own & aDots[d.x + 1, d.y + 1].Blocked == false
                    & aDots[d.x - 1, d.y - 2].Own == enemy_own & aDots[d.x - 1, d.y - 2].Blocked == false
                    & aDots[d.x, d.y - 1].Own != enemy_own & aDots[d.x, d.y - 1].Blocked == false
                    ...
                    & aDots[d.x - 2, d.y - 1].Own == 0 & aDots[d.x - 2, d.y - 1].Blocked == false
                select d;
 if (pat312_2.Count() > 0) return new Dot(pat312_2.First().x - 1, pat312_2.First().y + 1);
 //--------------Rotate on 90----------------------------------- 
 var pat312_2_3 = from Dot d in aDots
                  where d.Own == Owner
                      & aDots[d.x + 1, d.y + 1].Own == enemy_own & aDots[d.x + 1, d.y + 1].Blocked == false
                      & aDots[d.x - 2, d.y - 1].Own == enemy_own & aDots[d.x - 2, d.y - 1].Blocked == false
                      & aDots[d.x - 1, d.y].Own != enemy_own & aDots[d.x - 1, d.y].Blocked == false
                      ...
                      & aDots[d.x - 1, d.y - 2].Own == 0 & aDots[d.x - 1, d.y - 2].Blocked == false
                  select d;
 if (pat312_2_3.Count() > 0) return new Dot(pat312_2_3.First().x + 1, pat312_2_3.First().y - 1);
 //--------------Rotate on 90 - 2----------------------------------- 
 var pat312_2_3_4 = from Dot d in aDots
                    where d.Own == Owner
                        & aDots[d.x - 1, d.y - 1].Own == enemy_own & aDots[d.x - 1, d.y - 1].Blocked == false
                        & aDots[d.x + 2, d.y + 1].Own == enemy_own & aDots[d.x + 2, d.y + 1].Blocked == false
                        & aDots[d.x + 1, d.y].Own != enemy_own & aDots[d.x + 1, d.y].Blocked == false
                        ...
                        & aDots[d.x + 1, d.y + 2].Own == 0 & aDots[d.x + 1, d.y + 2].Blocked == false
                    select d;
 if (pat312_2_3_4.Count() > 0) return new Dot(pat312_2_3_4.First().x - 1, pat312_2_3_4.First().y + 1);
 //============================================================================================================== 
 NumberPattern = 169;
 var pat169 = from Dot d in aDots
              where d.Own == Owner
                  & aDots[d.x, d.y - 1].Own == enemy_own & aDots[d.x, d.y - 1].Blocked == false
                  & aDots[d.x, d.y + 3].Own == enemy_own & aDots[d.x, d.y + 3].Blocked == false
                  & aDots[d.x + 1, d.y - 1].Own == 0 & aDots[d.x + 1, d.y - 1].Blocked == false
                  ...
                  & aDots[d.x, d.y + 2].Own == 0 & aDots[d.x, d.y + 2].Blocked == false
              select d;
 if (pat169.Count() > 0) return new Dot(pat169.First().x + 1, pat169.First().y);
 //180 Rotate=========================================================================================================== 
 var pat169_2 = from Dot d in aDots
                where d.Own == Owner
                    & aDots[d.x, d.y + 1].Own == enemy_own & aDots[d.x, d.y + 1].Blocked == false
                    & aDots[d.x, d.y - 3].Own == enemy_own & aDots[d.x, d.y - 3].Blocked == false
                    & aDots[d.x - 1, d.y + 1].Own == 0 & aDots[d.x - 1, d.y + 1].Blocked == false
                    ...
                    & aDots[d.x, d.y - 2].Own == 0 & aDots[d.x, d.y - 2].Blocked == false
                select d;
 if (pat169_2.Count() > 0) return new Dot(pat169_2.First().x - 1, pat169_2.First().y);
 //--------------Rotate on 90----------------------------------- 
 var pat169_2_3 = from Dot d in aDots
                  where d.Own == Owner
                      & aDots[d.x + 1, d.y].Own == enemy_own & aDots[d.x + 1, d.y].Blocked == false
                      & aDots[d.x - 3, d.y].Own == enemy_own & aDots[d.x - 3, d.y].Blocked == false
                      & aDots[d.x + 1, d.y - 1].Own == 0 & aDots[d.x + 1, d.y - 1].Blocked == false
                      ...
                      & aDots[d.x - 2, d.y].Own == 0 & aDots[d.x - 2, d.y].Blocked == false
                  select d;
 if (pat169_2_3.Count() > 0) return new Dot(pat169_2_3.First().x, pat169_2_3.First().y - 1);
 //--------------Rotate on 90 - 2----------------------------------- 
 var pat169_2_3_4 = from Dot d in aDots
                    where d.Own == Owner
                        & aDots[d.x - 1, d.y].Own == enemy_own & aDots[d.x - 1, d.y].Blocked == false
                        & aDots[d.x + 3, d.y].Own == enemy_own & aDots[d.x + 3, d.y].Blocked == false
                        & aDots[d.x - 1, d.y + 1].Own == 0 & aDots[d.x - 1, d.y + 1].Blocked == false
                        ...
                        & aDots[d.x + 2, d.y].Own == 0 & aDots[d.x + 2, d.y].Blocked == false
                    select d;
 if (pat169_2_3_4.Count() > 0) return new Dot(pat169_2_3_4.First().x, pat169_2_3_4.First().y + 1);
 //============================================================================================================== 
 NumberPattern = 30;
 var pat30 = from Dot d in aDots
             where d.Own == Owner
                 & aDots[d.x + 1, d.y - 2].Own == enemy_own & aDots[d.x + 1, d.y - 2].Blocked == false
                 & aDots[d.x + 1, d.y - 1].Own == Owner & aDots[d.x + 1, d.y - 1].Blocked == false
                 & aDots[d.x, d.y - 1].Own == enemy_own & aDots[d.x, d.y - 1].Blocked == false
 ...
 //180 Rotate=========================================================================================================== 
 var pat30_2 = from Dot d in aDots
               where d.Own == Owner
                   & aDots[d.x - 1, d.y + 2].Own == enemy_own & aDots[d.x - 1, d.y + 2].Blocked == false
                   & aDots[d.x - 1, d.y + 1].Own == Owner & aDots[d.x - 1, d.y + 1].Blocked == false
                   & aDots[d.x, d.y + 1].Own == enemy_own & aDots[d.x, d.y + 1].Blocked == false
 ...
 //--------------Rotate on 90----------------------------------- 
 var pat30_2_3 = from Dot d in aDots
                 where d.Own == Owner
                     & aDots[d.x + 2, d.y - 1].Own == enemy_own & aDots[d.x + 2, d.y - 1].Blocked == false
                     & aDots[d.x + 1, d.y - 1].Own == Owner & aDots[d.x + 1, d.y - 1].Blocked == false
                     & aDots[d.x + 1, d.y].Own == enemy_own & aDots[d.x + 1, d.y].Blocked == false
 ...
 //--------------Rotate on 90 - 2----------------------------------- 
 var pat30_2_3_4 = from Dot d in aDots
                   where d.Own == Owner
                       & aDots[d.x - 2, d.y + 1].Own == enemy_own & aDots[d.x - 2, d.y + 1].Blocked == false
                       & aDots[d.x - 1, d.y + 1].Own == Owner & aDots[d.x - 1, d.y + 1].Blocked == false
                       & aDots[d.x - 1, d.y].Own == enemy_own & aDots[d.x - 1, d.y].Blocked == false
 ...
 //============================================================================================================== 
 NumberPattern = 740;
 var pat740 = from Dot d in aDots
              where d.Own == Owner
                  && aDots[d.x - 3, d.y + 1].Own == enemy_own && aDots[d.x - 3, d.y + 1].Blocked == false
                  && aDots[d.x, d.y - 2].Own == enemy_own && aDots[d.x, d.y - 2].Blocked == false
                  && aDots[d.x, d.y - 1].Own == 0 && aDots[d.x, d.y - 1].Blocked == false
                  ...
                  && aDots[d.x, d.y + 1].Own == 0 && aDots[d.x, d.y + 1].Blocked == false
              select d;
 if (pat740.Count() > 0) return new Dot(pat740.First().x, pat740.First().y + 1);
 //180 Rotate=========================================================================================================== 
 var pat740_2 = from Dot d in aDots
                where d.Own == Owner
                    && aDots[d.x + 3, d.y - 1].Own == enemy_own && aDots[d.x + 3, d.y - 1].Blocked == false
                    && aDots[d.x, d.y + 2].Own == enemy_own && aDots[d.x, d.y + 2].Blocked == false
                    && aDots[d.x, d.y + 1].Own == 0 && aDots[d.x, d.y + 1].Blocked == false
                    ...
                    && aDots[d.x, d.y - 1].Own == 0 && aDots[d.x, d.y - 1].Blocked == false
                select d;
 if (pat740_2.Count() > 0) return new Dot(pat740_2.First().x, pat740_2.First().y - 1);
 //--------------Rotate on 90----------------------------------- 
 var pat740_2_3 = from Dot d in aDots
                  where d.Own == Owner
                      && aDots[d.x - 1, d.y + 3].Own == enemy_own && aDots[d.x - 1, d.y + 3].Blocked == false
                      && aDots[d.x + 2, d.y].Own == enemy_own && aDots[d.x + 2, d.y].Blocked == false
                      && aDots[d.x + 1, d.y].Own == 0 && aDots[d.x + 1, d.y].Blocked == false
                      ...
                      && aDots[d.x - 1, d.y].Own == 0 && aDots[d.x - 1, d.y].Blocked == false
                  select d;
 if (pat740_2_3.Count() > 0) return new Dot(pat740_2_3.First().x - 1, pat740_2_3.First().y);
 //--------------Rotate on 90 - 2----------------------------------- 
 var pat740_2_3_4 = from Dot d in aDots
                    where d.Own == Owner
                        && aDots[d.x + 1, d.y - 3].Own == enemy_own && aDots[d.x + 1, d.y - 3].Blocked == false
                        && aDots[d.x - 2, d.y].Own == enemy_own && aDots[d.x - 2, d.y].Blocked == false
                        && aDots[d.x - 1, d.y].Own == 0 && aDots[d.x - 1, d.y].Blocked == false
                        ...
                        && aDots[d.x + 1, d.y].Own == 0 && aDots[d.x + 1, d.y].Blocked == false
                    select d;
 if (pat740_2_3_4.Count() > 0) return new Dot(pat740_2_3_4.First().x + 1, pat740_2_3_4.First().y);
 //============================================================================================================== 
